...
My research is focused on learning algorithms for large scale graphs and dynamic networks. My [Google Scholar profile](https://scholar.google.com/citations?user=OPyjQHwAAAAJ&hl=en) can be visited for more details. Currently Iam working on problems associated to Combinatorial optimization for sparse and large graphs and deep learning methods for querying large scale traffic networks.
